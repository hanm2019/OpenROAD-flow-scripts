...
core_area = (die_area[0] + pad_width[0],
             die_area[1] + pad_width[1],
             die_area[2] - pad_width[2],
             die_area[3] - pad_width[3])
...
with open('io.tcl', 'w') as f:
    ...
    # io_line('place_pins', r'-hor_layers M8 -ver_layers M7 -min_distance 1 -min_distance_in_tracks')
