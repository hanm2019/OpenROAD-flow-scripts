...
pin_left = \
    ['io_left_pbr0_stop_weight', 'io_left_pbr0_stall'] + \
    ['io_left_pbr0_data[{}]'.format(i) for i in range(DATA_WIDTH)] + \
    ['io_left_pbr1_stop_weight', 'io_left_pbr1_stall'] + \
    ['io_left_pbr1_data[{}]'.format(i) for i in range(DATA_WIDTH)]
pin_right = \
    ['io_right_pbr0_stop_weight', 'io_right_pbr0_stall'] + \
    ['io_right_pbr0_data[{}]'.format(i) for i in range(DATA_WIDTH)] + \
    ['io_right_pbr1_stop_weight', 'io_right_pbr1_stall'] + \
    ['io_right_pbr1_data[{}]'.format(i) for i in range(DATA_WIDTH)]
pin_top = \
    ['io_up_pbc0_is_weight'] + \
    ['io_up_pbc0_data[{}]'.format(i) for i in range(DATA_WIDTH)] + \
    ['io_up_pbc1_is_weight'] + \
    ['io_up_pbc1_data[{}]'.format(i) for i in range(DATA_WIDTH)]
pin_bottom  = \
    ['io_down_pbc0_is_weight'] + \
    ['io_down_pbc0_data[{}]'.format(i) for i in range(DATA_WIDTH)] + \
    ['io_down_pbc1_is_weight'] + \
    ['io_down_pbc1_data[{}]'.format(i) for i in range(DATA_WIDTH)]
